...
class CardList extends Component<Props, State> {
    ...
    async fetchData(term: string) {
        ...
        try {
            ...
            if (term) {
                ...
                const detailedData = await Promise.all(detailResponses.map((res) => res.json()));
    ...
    render() {
        ...
        if (error) {
            return <div className="text-center text-red-600 font-semibold p-4 bg-red-100 rounded">
                Error: {error}
            </div>;
        }
            ...
            <div>
                ...
                <div className="flex justify-center gap-4 mt-6">
                    <button
                        ...
                        onClick={() => this.setState({ page: this.state.page - 1 }, () => this.fetchData(this.props.searchTerm))}
